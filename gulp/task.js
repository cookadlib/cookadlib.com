...
export {task as icons} from './tasks/icons';
...
export {task as removeOldBuildIndex} from './tasks/remove-old-build-index';
export {task as renameIndex} from './tasks/rename-index';
export {task as renameSpritesheet} from './tasks/rename-spritesheet';
